...
public class PaginaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            double peso = Double.parseDouble(request.getParameter("cpPeso"));
            double altura = Double.parseDouble(request.getParameter("cpAltura"));
...
//            out.println("<h1>Olá " + nome + ", bem vindo ao IMC Calculator</h1>");            
//            
//            out.println("<h1>Seu IMC é " + Calculadora.getIMC(altura, peso) + "</h1>");
//
//
//            out.println("</body>");
//            out.println("</html>");  
